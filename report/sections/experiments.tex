...
\begin{table}[ht]
  \centering
  \caption{Test-set accuracy (\%) and macro-F1 (\%) on NCT-CRC-HE-100K across a subset of
...
As the experiments show, although the highest performance is achieved by the data-augmented CNN, the G-CNN outperforms 
both other models, especially at low-data training regimes.
